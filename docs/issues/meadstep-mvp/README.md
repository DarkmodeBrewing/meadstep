...
Issues `001` through `004` have been implemented. Remaining slices are marked AFK because the PRD and decision log resolve the major product, formula, UI, and Angular architecture decisions for MVP.
