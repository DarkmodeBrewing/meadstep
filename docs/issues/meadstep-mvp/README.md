...
6. `006-honey-planner-initial-og.md` - initial honey plan with auto cap and manual override. Implemented.
7. `007-step-feeding-schedule.md` - step-feed count, feed caps, and milestones. Implemented.
...
Issues `001` through `007` have been implemented. Remaining slices are marked AFK because the PRD and decision log resolve the major product, formula, UI, and Angular architecture decisions for MVP.
